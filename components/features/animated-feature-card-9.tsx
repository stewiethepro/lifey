...
let notifications = [
  {
    name: "Schedule haircut",
    description: "Book appointment at favorite salon",
    time: "15m ago",
    icon: "✂️",
    color: "#00C9A7",
  },
  {
    name: "Order birthday gift",
    description: "Find and purchase gift for Sarah",
    time: "10m ago",
    icon: "🎁",
    color: "#FFB800",
  },
  ...
  },
  {
    ...
    description: "Process online renewal for 6 months",
    time: "2m ago",
    icon: "🏋️",
    color: "#1E86FF",
  },
...
interface FeatureCard9Props {
  className?: string;
}

export function FeatureCard9({ className }: FeatureCard9Props) {
  return (
    <div className="relative flex h-full max-h-[500px] min-h-[500px] w-full max-w-[42rem] transform-gpu flex-col justify-between overflow-hidden rounded-lg border bg-white [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] dark:bg-black dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]">
      ...
      <div className="flex flex-col items-start gap-y-1 border-t p-4 dark:border-neutral-800">
        ...
        <p className="text-base font-normal text-neutral-500 dark:text-neutral-400">
          Let Lifey know what needs doing.
        </p>
      </div>
    </div>
  );
