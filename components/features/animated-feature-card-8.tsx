...
export function FeatureCard8() {
  ...
  return (
    <div className="relative h-full w-full max-w-[42rem] transform-gpu rounded-lg border bg-white [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] dark:bg-black dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] md:max-h-[500px]">
      <motion.div
      ...
      >
        <div className="flex h-full w-full cursor-pointer flex-col items-center justify-center gap-y-1 overflow-hidden rounded-t-xl bg-transparent">
          <div className="relative flex flex-col items-center justify-center gap-y-2 px-10 py-20">
            ...
            >
              ...
              <div className="w-[calc(100%-3rem)]">
                <h3 className="text-base font-semibold">Lifey</h3>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">
                  On it ✅
                </p>
              </div>
        ...
        <div className="flex w-full flex-col items-start border-t border-neutral-200 p-4 dark:border-neutral-800">
          <h2 className="text-xl font-semibold">Lifey gets it done</h2>
          <p className="text-base font-normal text-neutral-500 dark:text-neutral-400">
            Lifey angels descend from the heavens and sort your shit out.
          </p>
        </div>
      </motion.div>
    </div>
