    ...
    <foreignObject width="100%" height="100%" externalResourcesRequired="true">
      <div
        ...
        style={{
          ...
          baselineSource: "auto",
          blockSize: 600,
          borderBlockEnd: "0 solid #e5e7eb",
          borderBlockStart: "0 solid #e5e7eb",
          borderCollapse: "separate",
          borderColor: "#e5e7eb",
          borderEndEndRadius: 0,
          borderEndStartRadius: 0,
          borderImage: "none 100%/1/0 stretch",
          borderInlineEnd: "0 solid #e5e7eb",
          borderInlineStart: "0 solid #e5e7eb",
          borderRadius: 0,
          borderSpacing: 0,
          ...
          breakInside: "auto",
          captionSide: "top",
          caretColor: "rgba(48,48,48,.8)",
          clear: "none",
          columnRule: "0 rgba(48,48,48,.8)",
          columnSpan: "none",
          columns: "auto",
          ...
          textEmphasis: "none rgba(48,48,48,.8)",
          textIndent: 0,
          textOverflow: "clip",
          textShadow: "none",
          textSizeAdjust: "100%",
      ...
      >
        <div
          ...
          baselineShift={0}
          buffered-rendering="auto"
          className="w-full aspect-square overflow-hidden flex justify-center items-center shadow-xl"
          clip="auto"
          color="rgba(48, 48, 48, 0.8)"
          colorInterpolation="srgb"
          colorInterpolationFilters="linearrgb"
          ...
          style={{
            ...
            backgroundBlendMode: "normal",
            background:
              "linear-gradient(45deg,#ef709b 0,#ff930f 100%)0 0/auto padding-box border-box",
            baselineSource: "auto",
            blockSize: 510,
            borderBlockEnd: "0 solid #e5e7eb",
            borderBlockStart: "0 solid #e5e7eb",
            ...
            borderWidth: 0,
            boxShadow:
              "transparent 0 0 0 0,transparent 0 0 0 0,rgba(0,0,0,.1)0 20px 25px -5px,rgba(0,0,0,.1)0 8px 10px -6px",
            boxSizing: "border-box",
            breakAfter: "auto",
            breakBefore: "auto",
            breakInside: "auto",
